...
//------------------------------------------------
/*
 * jackson update _click 20130731
 * */
...
artDialog.fn = artDialog.prototype = {
	...
	_init: function (config) {
		var that = this, DOM,
			...
			: {backgroundImage: 'url(\'' + LEx.webPath+"public/scripts/dialog" + '/skins/icons/' + icon + '.png\')'});
	...
	lock: function () {
		...
		lockMask.unbind('dblclick');
		if(that.config.dblclickClose){
	...
	return typeof fn !== 'function' || fn.call(that, window,btnObj) !== false ?
		that.close() : that;
	},
...
artDialog.defaults = {
	...
	dblclickClose:true			// 是否允许双击遮罩关闭窗口，默认允许
};
