 ...
 */
 	...
 	$(control+" [reg],[fun]:not([reg]),[tip]").hover(
 		function(e) {
 			if($(this).attr('tip') != undefined){
 				...
 				$('body').append( '<p id="vtip" style="position: absolute;color:red;">' + $(this).attr('tip') + '</p>' );
 ...
 function validate(obj){
 	...
 	if($(obj).get(0).tagName == 'INPUT' && ($(obj).attr('type') == 'radio' || $(obj).attr('type') == 'checkbox')){
 ...
 function change_error_style(obj,action_type){
	 if(action_type == "add"){
		 obj.parents("div .survey-item").addClass("input_validation-failed");
		 obj.addClass("input_validation-failed");
		 /*if(obj.attr('isSurvey') == 'survey'){
			 obj.parents("div .survey-item").addClass("input_validation-failed");
		 }else{
			 obj.addClass("input_validation-failed");
		 }*/
	 }else{
		 obj.parents("div .survey-item").removeClass("input_validation-failed");
