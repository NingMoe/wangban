...
function ckstyle() { //定义总的风格
    var ck = new Object();
    ck.cpath=CONST.RESOURCE_URL+'/js/docpreview/ckplayer/assets/';
	...
	*/
	ck.setup='1,1,1,0,1,1,0,1,2,0,1,1,200,0,1,1,0,1,1,1,2,10,3';
	/*
	总体设置：
	...
	*/
	...
	ck.cpt_share=CONST.RESOURCE_URL+'/js/docpreview/ckplayer/share.xml';
	/*分享插件调用的配置文件地址*/
	//调用插件开始
    ck.cpt_list = ckcpt();
    return ck;
