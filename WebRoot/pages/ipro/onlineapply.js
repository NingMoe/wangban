...
$(function(){	
	...
	*/
	...
	/* if(neworold=="修改"){
		 $("#permitItemCode").val(PERMIT_ITEM_NAME);
			$("#permitItemCode").html($("#permitItemName").val());
			$("#permitItemCode").attr("value",code);
		 }*/
	/*
	...
	*/
	...
	if(types=="外商投资"){
		...
		$(".ws").hide();	
		$("#contrInfo_form").hide();
		$(".touzi").hide();//自己有境外投資和外商投資，有投資方式選項
	}
	//end  by cys
...
function checkit(){
	...
	var deAreaName=$("#deAreaName").val().trim();
