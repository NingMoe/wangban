...
$(function() {
	...
	dsy.add("0_0_0",["迎江","大观","宜秀","桐城"," 怀宁","枞阳","潜山","太湖","宿松","望江","岳西"]);
	dsy.add("0_0_1",["蚌山区","龙子湖","禹会区","淮上区","怀远县","五河县","固镇县"]);
	dsy.add("0_0_2",["居巢区","含山县","和县","庐江县","无为县"]);
	dsy.add("0_0_3",["贵池区","东至县","青阳县","石台县"]);
	dsy.add("0_0_4",["琅琊区","定远县","凤阳县","来安县","明光市","全椒县","天长市","南谯区"]);
	dsy.add("0_0_5",["阜南县","颍州区","界首市","临泉县","太和县","颖上县","颍东区","颍泉区"]);
	dsy.add("0_0_6",[ "庐阳区","瑶海区","蜀山区","包河区","长丰县","肥东县","肥西县"]);
	dsy.add("0_0_7",["相山区","杜集区","烈山区","濉溪县"]);
	dsy.add("0_0_8",["田家庵","大通区","谢家集","八公山","潘集区","凤台县"]);
	dsy.add("0_0_9",["黄山区","祁门县","休宁县","歙县","黟县","徽州区","屯溪区"]);
	dsy.add("0_0_10",["金安区","裕安区","寿 县","霍邱县","舒城县","金寨县","霍山县"]);
	dsy.add("0_0_11",["雨山区","金家庄","花山区","当涂县"]);
	dsy.add("0_0_12",["灵璧县","埇桥区","萧县","泗县","砀山县"]);
	dsy.add("0_0_13",["铜官山","狮子山","郊 区","铜陵县"]);
	dsy.add("0_0_14",["镜湖区","弋江区","鸠江区","三山区","芜湖县","繁昌县","南陵县"]);
	dsy.add("0_0_15",["广德县","绩溪县","郎溪县","宁国市","宣州区","泾县","旌德县"]);
	dsy.add("0_0_16",["利辛县","蒙城县","涡阳县","谯城区"]);
	dsy.add("0_1",["北京"]);
	...
	dsy.add("0_2_0",["鼓楼区","台江区","仓山区","马尾区","晋安区","闽侯县","连江县","罗源县","闽清县","永泰县","平潭县","福清市","长乐"]);
	dsy.add("0_2_1",["长汀县","连城县","新罗区","上杭县","武平县","永定县","漳平市"]);
	dsy.add("0_2_2",["光泽县","建阳市","建瓯市","延平区","浦城县","邵武市","顺昌县","松溪县","武夷山","政和县"]);
	dsy.add("0_2_3",["蕉城区","福鼎市","古田县","宁德市","屏南县","寿宁县","霞浦县","周宁县","柘荣县"]);
	dsy.add("0_2_4",["城厢区","涵江区","荔城区","秀屿区","仙游县"]);
	dsy.add("0_2_5",["鲤城区","丰泽区","洛江区","泉港区","惠安县","安溪县","永春县","德化县","金门县","石狮市","晋江市","南安市"]);
	dsy.add("0_2_6",["大田县","建宁县","将乐县","明溪县","宁化县","清流县","三元区","沙县","泰宁县","永安市","尤溪县","梅列区"]);
	dsy.add("0_2_7",["思明区","海沧区","湖里区","集美区","同安区","翔安区"]);
	dsy.add("0_2_8",["芗城区","龙文区","云霄县","漳浦县","诏安县","长泰县","东山县","南靖县","平和县","华安县","龙海市"]);
	dsy.add("0_3",["白银","定西","甘南州","嘉峪关","金昌","酒泉","兰州","临夏州","陇南","平凉","庆 阳","天水","武威","张掖"]);
	dsy.add("0_3_0",["白银区","平川区","会宁县","景泰县","靖远县"]);
	dsy.add("0_3_1",["安定区","临洮县","陇西县","通渭县","渭源县","漳县","岷县"]);
	dsy.add("0_3_2",["迭部县","合作市","临潭县","碌曲县","玛曲县","夏河县","舟曲县","卓尼县"]);
	dsy.add("0_3_3",["嘉峪关市"]);
	dsy.add("0_3_4",["金川区","永昌县"]);
	dsy.add("0_3_5",["肃州区","玉门市","敦煌市","金塔县","瓜州县","肃北蒙古族自治县","阿克塞哈萨克族自治县"]);
	dsy.add("0_3_6",["城关区","七里河","西固区","安宁区","红古区","永登县","皋兰县","榆中县"]);
	...
	dsy.add("0_4_0",["潮安县","湘桥区","饶平县"]);
	dsy.add("0_4_1",["东莞市"]);
	dsy.add("0_4_2",["禅城区","南海区","顺德区","三水区","高明区"]);
	dsy.add("0_4_3",["越秀区","荔湾区","海珠区","天河区","白云区","黄埔区","番禺区","花都区","南沙区","萝岗区","增城市","从化市"]);
	dsy.add("0_4_4",["东源县","和平县","源城区","连平县","龙川县","紫金县"]);
	dsy.add("0_4_5",["博罗县","惠东县","惠阳区","惠城区","龙门县"]);
	dsy.add("0_4_6",["江海区","蓬江区","新会区","台山市","开平市","鹤山市","恩平市"]);
	dsy.add("0_4_7",["惠来县","揭东县","揭西县","揭阳市","榕城区"]);
	...
	dsy.add("0_6",["安顺","毕节","贵阳","六盘水","黔东南苗族侗族自治州","黔南布依族苗族自治州","黔西南布依族苗族自治州","铜仁","遵义"]);dsy.add("0_6_0",["安顺市","关岭布依族苗族自治县","平坝县","普定县","镇宁布依族苗族自治县","紫云苗族布依族自治县"]);
	...
	dsy.add("0_20_9",["即墨市","黄岛区","胶州市","李沧区","平度市","崂山区","市南区","市北区","四方区","城阳区"]);
	...
	dsy.add("0_28_6",["五华区","盘龙区","官渡区","西山区","东川区","安宁市","呈贡县","富民县","晋宁县","昆明市","禄劝彝族苗族自治县","石林彝族自治县","寻甸回族自治县","宜良县","嵩明县"]);
...
function setup()
{
	if(document.getElementById(s_input[0])!=null){
		for(var i=0;i<s_input.length-1;i++) {
			document.getElementById(s_input[i]).onchange=new Function("change("+(i+1)+")");
		}
		change(0);
	}
	//数据绑定时，省市县三个字段option还未加载处理
	//这里等待加载完毕后，再进行赋值
...
function change(v) {
	var str = "0";
	for (var i = 0; i < v; i++) {
		str += ("_" + (document.getElementById(s_input[i]).selectedIndex - 1));
	};
	var ss = document.getElementById(s_input[v]);
	with(ss) {
		length = 0;
		options[0] = new Option(opt0[v], opt0[v]);

		if (v && document.getElementById(s_input[v - 1]).selectedIndex > 0 || !v) {
			if (dsy.Exists(str)) {
				ar = dsy.Items[str];
...
function cidInfo(sId) {
	...
	if (sId=="111111111111111") {
		LEx.alert("输入的证件编号不正确!");
		return false;
	}
	if (!(/(^\d{15}$)|(^\d{17}([0-9]|X)$)/.test(sId))) {
		LEx.alert("输入的身份证号长度不对，或者号码不符合规定！\n15位号码应全为数字，18位号码末位可以为数字或X");
		return false;
	}
	...
	if (iCount == 18) {
		...
		if (iSum % 11 != 1) { alert("证件输入不合法"); return false; }
	}
	return true;
}
function checkCardNo(o) {
	var reg;
	var zjlx = $("#identityType").val();
	var v=$(o).val();
	if(zjlx==10){
		if(!cidInfo($(o).val())){
...
//企业 法人证件号 失去焦点certificateNo1赋值到certificateNo
function checkCertificateNo(o){
	var zjlx = $("#certificateName").val();
	var v=$(o).val();
	if(zjlx=="身份证"){
		if(!cidInfo($(o).val())){
			$(o).removeClass("input_validation-valid").addClass("input_validation-invalid");
	...
	if(!reg.test(val)){
		...
		$(o).removeClass("input_validation-invalid").addClass("input_validation-valid");
		if($(o).attr("name")=="certificateNo"){
			if(val.indexOf("*") < 0){
				$("#certificateNo").val(val);
			}
			if(val.length>0){
				$(o).val("******"+val.substr(6,8)+"****");
			}
		}
		return true;
	}
...
function setBusinessAttach(obj,uid){
 ...
 //根据上传文件获取与其相似文件
function getSimilarFile(name,uid){
	var cmd = new LEx.Command("app.icity.project.WdwpCmd");
	cmd.setParameter("name", name);
	cmd.setParameter("UID", uid+"");
	var ret =  cmd.execute("getSimilarFile");
	return ret;	
}
//对上传文件重命名
function getFileRename(name,uid){
	var cmd = new LEx.Command("app.icity.project.WdwpCmd");
	cmd.setParameter("name", name);
	cmd.setParameter("UID", uid+"");
	var ret =  cmd.execute("getFileRename");
	return ret;	
}
...
function validate(o) {
	...
	if(!reg.test(val)){
		...
		$(o).removeClass("input_validation-invalid").addClass("input_validation-valid");
		if($(o).attr("name")=="linkPhone"){
			if(val.indexOf("*") < 0){
				$("#linkPhone").val(val);
			}
			if(val.length>0){
				$(o).val(val.substr(0,3)+"****"+val.substr(7,7));
			}
		}

		if($(o).attr("name")=="contactPhone"){
			$("#contactPhone").val(val);
		}  
		return true;
	}
...
function loadForm(obj){
	...
	if(OBJECT_TYPE=="1"){
		$("#base").html(LEx.processDOMTemplate("persontemplate",data));
		...
		$("#base").html(LEx.processDOMTemplate("companytemplate",data));
		...
		$("#base").html(LEx.processDOMTemplate("projecttemplate",data));
		$(".xm").attr("checked","true");
		type = "2";
	}
	setdisabled(object_types);
	loadInfo(OBJECT_TYPE);
}
//设置表单类型 可用 不可用
function setdisabled(object_types){
	var lens = object_types.length;
	$(".gr").attr("disabled","disabled");
	$(".qy").attr("disabled","disabled");
	$(".xm").attr("disabled","disabled");
	for(var i=0;i<lens;i++){
		var o = object_types[i];
		if(o=="1"){
			$(".gr").removeAttr("disabled");
		}else if(o=="2"){
			$(".xm").removeAttr("disabled");
		}else if(o=="3"){
			$(".qy").removeAttr("disabled");
		}
	}
}
//自动加载基本信息
function loadInfo(type) {
	//个人
	if(type=="1") {
		var u_type = userInfo.TYPE;
		if(u_type == "11") {
			$("#name").val(userInfo.NAME);//姓名
			$("#identityType").val(userInfo.CARD_TYPE);//证件类型
			$("[name=idcardNo]").val(userInfo.CARD_NO);//证件编号
			$("[name=linkPhone]").val(userInfo.PHONE);//联系电话
			$("#linkAddress").val(userInfo.ADDRESS);//联系地址
			$("#email").val(userInfo.EMAIL);//邮箱
			$("#birthday_str").val(userInfo.BIRTHDAY);//生日
			$("#politicalStatus").val(userInfo.POLITICALSTATUS);//政治面貌
			$("#sex").val(userInfo.SEX);//性别
			$("#postCode").val(userInfo.POSTCODE);//邮政编码
			$("#education").val(userInfo.EDUCATION);//学历
			$("#nation").val(userInfo.NATION);//民族
			$("#nativePlace").val(userInfo.NATIVEPLACE);//籍贯
			$("#homeAddress").val(userInfo.HOMEADDRESS);//户口所在地
		}
	}
	//企业
	else if(type=="3") {
		$("#orgName").val(userInfo.ORG_NAME);//组织机构名称
		$("#orgCode").val(userInfo.ICREGNUMBER);//组织机构代码
		$("#legalPerson").val(userInfo.ORG_BOSS_TYPE);//法人证件类型
		$("#certificateNo").val(userInfo.ORG_BOSS_NO);//法人证件号码"******"+val.substr(6,8)+"****"
		$("#certificateNo1").val($("#certificateNo").val());//法人证件号码
		$("#legalPerson").val(userInfo.ORG_BOSS_NAME);//法人姓名
		
		//userInfo.Phone的数据是注册时候填写的号码
	    $("#contactPhone").val(userInfo.PHONE);
		$("#contactPhone1").val($("#contactPhone").val());
		//联系人 默认 不绑定数据
		//$("#linkMan").val(userInfo.NAME);
		$("#registerAddress").val(userInfo.ADDRESS);//单位注册地址
		$("#orgCodeAwardOrg").val(userInfo.ORGCODEAWARDORG);//组织机构代码发证机构
		$("#orgCodeValidPeriodStart_str").val(userInfo.ORGCODEVALIDPERIODSTART_STR);//组织机构代码证有效期起
		$("#orgCodeValidPeriodEnd_str").val(userInfo.ORGCODEVALIDPERIODEND_STR);//组织机构代码证有效期止
		$("#orgEnglishName").val(userInfo.ORGENGLISHNAME);//机构英文名称
		$("#orgType").val(userInfo.ORGTYPE);//组织机构类型
		$("#orgActuality").val(userInfo.ORGACTUALITY);//组织机构现状
		$("#enterpriseSortCode").val(userInfo.ENTERPRISESORTCODE);//企业类别代码
		$("#enterpriseSortName").val(userInfo.ENTERPRISESORTNAME);//企业类别名称
		$("#orgCodeAwardDate_str").val(userInfo.ORGCODEAWARDDATE_STR);//组织机构代码证发证日期
		$("#registerDate_str").val(userInfo.REGISTERDATE_STR);//登记注册日期
		$("#businessScope").val(userInfo.BUSINESS_SCOPE);//经营范围
		$("#creditCode").val(userInfo.CREDIT_CODE);//统一社会信用代码
		//潍坊的 新增社会统一编号 是否使用多证合一
		$("input[name='isMultiple']").on('click', function(event) {
			var isMultiple = $("input[name='isMultiple']:checked").val();
			if(isMultiple=="1"){
				$("#creditCode").attr("reg","^\S{18}$");
				$("#creditCodeTr").show();
			}else{
				$("#creditCode").attr("reg","");
				$("#creditCodeTr").hide();
	...
	//项目
		...
		//联系人 默认 不绑定数据
		//$("#linkMan").val(userInfo.NAME);
		$("#contractor").val(userInfo.ORG_NAME);
		$("#linkPhone").val(userInfo.PHONE);
		$("#linkPhone1").val($("#linkPhone").val());
	}
}
//构造数据
function buildData(){
	apply_data.metail = docids;
	//昆明不用，十堰不用//聊城、重庆、烟台、新余、山东、临沂、德州、潍坊、商丘、西宁
	apply_data.windowsub = checked_materials;
	if(isSetUp == 0) {
		formInfo=LEx.form.get("baseinfo","id");
		if(type=="1"){
			apply_data.zjhm = $("#idcardNo").val();
			apply_data.sqrxm = $("#name").val();
			apply_data.lxrxm = $("#name").val();
			apply_data.lxrphone = $("#linkPhone").val();
		}else if(type=="3"){
			apply_data.zjhm = $("#orgCode").val();
			apply_data.sqrxm = $("#orgName").val();
			apply_data.lxrxm = $("#linkMan").val();
			apply_data.lxrphone = $("#contactPhone").val();
		}else if(type=="2"){
			apply_data.zjhm = $("#projectCode").val();
			apply_data.sqrxm = $("#projectName").val();
			apply_data.lxrxm = $("#linkMan").val();
			apply_data.lxrphone = $("#linkPhone").val();
		}
	}
	apply_data.userName = LEx.userInfo.userName;
	apply_data.ucid = LEx.userInfo.uid;
	apply_data.account = LEx.userInfo.userId;
	apply_data.info = formInfo;
	apply_data.objectType = type;//"{{OBJECT_TYPE}}";
	apply_data.powerType="{{power_type}}";
	apply_data.itemId = "{{itemInfo.ID}}";
	apply_data.itemCode = "{{itemInfo.CODE}}";
	apply_data.itemName = "{{itemInfo.NAME}}";
	apply_data.orgCode = "{{itemInfo.ORG_CODE}}";
	apply_data.orgName = "{{itemInfo.ORG_NAME}}";
	apply_data.regionCode="{{itemInfo.REGION_CODE}}";
	apply_data.regionName="{{itemInfo.REGION_NAME}}";
	apply_data.receiveNum  = sblsh;//申办流水号
	apply_data.formName="{{formName}}";
	apply_data.power_source="{{POWER_SOURCE}}";
	apply_data.urlAddress="{{urlAddress}}";//重庆食药局判断地址
	apply_data.sybmol="{{sybmol}}";//重庆食药局加密
	apply_data.userTypeCode="{{userInfo.TYPE}}";//重庆食药局用户类型
	//办件类型   1承诺件  2即办件 3上报件 4 联报件
	var assort = {{itemInfo.ASSORT}};
	if(assort == null){
		apply_data.assort = "1";
	}else{
		apply_data.assort = assort;
	}
	if(LEx.userInfo.type==999&&apply_data.assort=="2"){
		if(confirm("是否办结?")){
			apply_data.Transferred = "0";
		}else{
			apply_data.Transferred = "1";
		}
	}else{
		apply_data.Transferred = "1";
	}
...
function saveData(){
	if(current_step==1){
		if(!LEx.form.validate("#baseinfo")){
           if($("#name").attr('class')=="input_validation-invalid"){
        	   LEx.alert("姓名只能填写中文");
           }else LEx.alert("请正确填写必填项");
			return;
		}
	}
	if(current_step==2){
			if(LEx.isNotNull("{{urlAddress}}")){
				savetype="save";
				save_form();
				return;
			}else{
	...
	apply_data.ly="icity";
	//昆明使用 情形材料
	if("{{ConfigInfo.AppId}}"=="km"){
		apply_data.caseCode = _caseCode;
	}
	var command = new LEx.Command("app.icity.onlineapply.ApplyCmd");
	command.setParameter("data",apply_data);
	var ret=command.execute("saveDraft");
	if(!command.error){
		sblsh=ret.data;
		if("{{ConfigInfo.AppId}}"=="chq"){
			LEx.alert("保存成功，可在个人企业空间-我的办件中找到该事项，点击右侧的修改按钮继续办理");
		}else{
			LEx.alert("保存成功！");
		}
		if("{{ConfigInfo.WebRegion}}"=="370000000000"){
			window.location.href="{{PageContext.ContextPath}}icity/project";
		}
	}else{
		LEx.alert("保存失败！");
	}
...
function bindData(){
	...
	if(data!=""){
		if(state=="21"){
			$("#contextPerson").html(data.lxrxm);
			$("#userPhone").html(data.lxrphone);
		}
		var material = data.metail;
		var _baseContent = data.info;
		var mailInfo = data.mailInfo;
		province=_baseContent["province"];
		city=_baseContent["city"];
		county =_baseContent["county"];
		for (var key in _baseContent) {
			var value = _baseContent[key];
			$("[name="+key+"]").val(value);//以name属性来赋值
		}
		var len = material.length;
		if(LEx.isNotNull(mailInfo)){
			if(mailInfo.jglqfs=="1"){
				$("#baseinfo-05").find("input[name='jglqfs'][value='1']").click();
				$(".jglqfslb1").show();
				for(var k in mailInfo){
					$("#baseinfo-05").find("[name="+k+"]").val(mailInfo[k]);
				}
				$("#baseinfo-05").find("input[name='jglqfs']").eq(0).val(0);
			}
		}
		for(var i=0;i<len;i++){
			var wp_apply = {};
			wp_apply.DOCUMENT_NAME = material[i].DOCUMENT_NAME;
			wp_apply.FILE_PATH = material[i].FILE_PATH;
			wp_apply.FILE_NAME = material[i].FILE_NAME;
			wp_apply.DOCUMENT_ID = material[i].DOCUMENT_ID;
			wp_apply.URL = material[i].URL;
			wp_apply.TYPE = material[i].TYPE;
			wp_apply.OPERATOR_ID = LEx.userInfo.userId;
			wp_apply.OPERATOR_NAME = LEx.userInfo.userName;
			docids.push(wp_apply);
			if(material[i].FILE_NAME!=null&&material[i].FILE_NAME!=undefined){
				var bqbz=$("#list_"+material[i].DOCUMENT_ID).attr("bqbz");
				if(state=="21"){
					if(bqbz=="1"){
						$("#list_"+material[i].DOCUMENT_ID).append("<div style=\"text-align:right;margin-bottom:10px;\" id=\"file_"+material[i].FILE_PATH+"\">"+formatLen(material[i].FILE_NAME,0,20)+"&nbsp;&nbsp;<a class='btn btn-success btn-xs'  onclick=\"onDownload(this);\">下载</a> | <a class='btn btn-danger btn-xs'  onclick=\"onDel(this);\">删除</a>"+"</div>");
					}
					else{$("#list_"+material[i].DOCUMENT_ID).append("<div style=\"text-align:right;margin-bottom:10px;\" id=\"file_"+material[i].FILE_PATH+"\">"+formatLen(material[i].FILE_NAME,0,20)+"&nbsp;&nbsp;"+"</div>");}
				}else{
					$("#list_"+material[i].DOCUMENT_ID).append("<div style=\"text-align:right;margin-bottom:10px;\" id=\"file_"+material[i].FILE_PATH+"\">"+formatLen(material[i].FILE_NAME,0,20)+"&nbsp;&nbsp;<a class='btn btn-success btn-xs'  onclick=\"onDownload(this);\">下载</a> | <a class='btn btn-danger btn-xs'  onclick=\"onDel(this);\">删除</a>"+"</div>");
				}
				$("#file_"+material[i].FILE_PATH).attr("title",material[i].FILE_NAME);
				$("#file_"+material[i].FILE_PATH).attr("url",material[i].URL);
			}
		}
		var windowsub = data.windowsub;//选择窗口提交
		if(LEx.isNotNull(windowsub)){
			for(var i = 0;i<windowsub.length;i++){
				$("#ck_"+windowsub[i].code).attr("checked", true);
			}
		}
	}
}
function initFileUpload() {
	$('.fileupload').fileupload({
		...
		add : function(e, data) {
			var check=true;
			var __material_code=$(this).attr("id");
			var __material_name=$(this).attr("Name");
			$.each(data.files, function(i, file) {
				...
				//判断与上传文件相似的文件       
				var ret = getSimilarFile(file.name,LEx.userInfo.uid);
				if(ret.state=="1"){
					if(ret.total>0){
						var len = ret.total;
		    			var tr = "";
		    			for(var i = 0;i<len;i++){
		    				tr += "<tr> <td style=\"text-align:center;\"><input name=\"checkbox_repeatMaterial\" type=\"checkbox\" dname="+ret.data[i].URL+" yname="+ret.data[i].YNAME+" cid="+ret.data[i].DOCID+" value=\"checkbox_repeatMaterial\" /></td><td style=\"text-align:left;\">"+ret.data[i].YNAME+"</td><td style=\"text-align:center;\">"+ret.data[i].UPLOADTIME+"</td></tr>";
		    			}
				       var str="<div class=\"alert alert-danger\" style=\"padding: 8px;margin-bottom: 10px;\">已存在与上传文件类似文件</div>" +
				       		"<div style=\"overflow-x: auto; overflow-y: auto; height: 100px; width:200px;\"><table class=\"table table-bordered\" style=\"width:100%;\">" +
				       		"<tr>" +
				       		"<td></td>" +
							...
							button:[
							        {
					                 ...
					                 callback: function() {       	
					                	 var flag = false;
					             		var count = 0;
					             		$("input[name='checkbox_repeatMaterial']:checked").each(
					             			function(){
					             		...
					             		if(flag){
					             			$("input[name='checkbox_repeatMaterial']:checked").each(function(){
					             				var url = $(this).attr("dname");
					             				var name = $(this).attr("yname");
					             				var docid = $(this).attr("cid");
...
function uploadSuccess(e, serverData) {
	...
	for(var i=0;i<serverData.result.length;i++){
		...
		var ret = getFileRename(data.name,LEx.userInfo.uid);   
		if(ret.state=="1"){
			if(ret.total>0){
				data.yname = ret.data;
			}
		}
		$("#list_"+material_code).append("<div style=\"text-align:right;margin-bottom:10px;\" id=\"file_"+data.scc.docid+"\">"+formatLenStr(data.yname,0,14)+"<a class='btn btn-success btn-xs'  onclick=\"onDownload(this);\">下载</a> | <a class='btn btn-danger btn-xs'  onclick=\"onDel(this);\">删除</a>"+"</div>");
		$("#file_"+data.scc.docid).attr("title",data.yname);
		$("#file_"+data.scc.docid).attr("url",data.url);
		var wp_apply = {};
		wp_apply.DOCUMENT_NAME =material_name;
		wp_apply.FILE_PATH = data.scc.docid;
		wp_apply.FILE_NAME = $("#file_"+data.scc.docid).attr("title");
...
function fomatterDate(val){
	if(LEx.isNotNull(val)){
		return LEx.util.DateTool.formatDate(val);
	}else{
		return '-';
	}
}

function check4Material() {
	//是否上传必须文件或勾选窗口提交
	var upload_flag=false;
	if('undefined'==typeof must_materials)
		 return true;
	if(must_materials.length>0){	
		for(var j=0;j<must_materials.length;j++){
			upload_flag=false;
			if($("input[name='checkbox_window'][code="+must_materials[j]+"]").attr("checked")){
				upload_flag=true;
			}else{
				for(var i=0;i<docids.length;i++){
					if(must_materials[j]==docids[i].DOCUMENT_ID){
						upload_flag=true;
						break;
					}
					else{
