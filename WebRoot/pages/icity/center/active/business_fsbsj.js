...
function detail(id) {
	var n_url = LEx.webPath+"admin?m=icity/center/active/business_fsbsj_info.html&id="+id;	
	LEx.dialog({
		id : "yyxq",
		title : "预约详情",
		url : n_url,
