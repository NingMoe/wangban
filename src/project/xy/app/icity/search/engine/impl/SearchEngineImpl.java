package xy.app.icity.search.engine.impl;
...
import xy.app.icity.search.engine.SearchEngine;
import app.icity.search.pojo.AnalyzerFactory;
import xy.app.icity.search.pojo.SearchQuery;
...
public class SearchEngineImpl implements SearchEngine {
	...
	@Override
	public DataSet searchIndex(String indexPath, SearchQuery indexQuery) {
		...
		try {
			...
			if (isHighlight && ret.size() > 0) {
				...
				Analyzer analyzer = AnalyzerFactory.getInstance().getAnalyzer();
				SimpleHTMLFormatter simpleHtmlFormatter = new SimpleHTMLFormatter(highlightSimplePre, highlightSimplePost);// 设定高亮显示格式
