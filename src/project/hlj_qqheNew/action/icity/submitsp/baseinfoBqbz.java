...
public class baseinfoBqbz extends BaseAction{
	/**
	 * 
	 */
	private static final long serialVersionUID = -4247021991271706668L;
	...
	public boolean interfaceMode(Map<String, Object> data) {
		...
		String sblsh=this.getParameter("bqbz_sblsh");
		String flag = this.getParameter("flag");
		String itemId = this.getParameter("itemId");
		String region_code = this.getParameter("qhbm");
	//	String sblsh = this.getParameter("sblsh");
		DataSet resultsub = null;
		...
		String objectType = "";//办理对象类型 新事项分为 个人 企业 项目  先假设0为个人1为企业2为项目 
			...
			String sql = "select s.*,i.state from business_index i,sub_for_ex_app_information s where i.sblsh=s.sblsh ";
