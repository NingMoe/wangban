...
public class setCo extends BaseAction {
	/**
	 * 
	 */
	...
	public boolean handler(Map<String, Object> data) throws Exception {
		...
		if(StringUtils.isEmpty(ticket)){
			ticket = this.getParameter("ticket");
		}
		String gotoURL = map.get("gotoURL");
		if(StringUtils.isEmpty(gotoURL)){
			gotoURL = this.getParameter("gotoURL");
		}
		this.setCookie(cookieName, ticket);
		if (StringUtils.isEmpty(gotoURL)) {
	...
	protected JSONObject post(NameValuePair[] params) {
